...
def main() -> None:
    ...
    pair_grid = {
        "short_n": [8, 10],
        "long_n": [32, 40],
        "trend_gap_min": [0.01, 0.014],
        "pullback_min": [0.005, 0.007],
        "bid_strength_min": [0.02, 0.03],
        "spread_cap": [0.016, 0.02],
        "entry_price_cap": [0.95, 0.98],
    ...
    dom_grid = {
        "bid_min": [0.94, 0.95],
        "strength_min": [0.04, 0.06],
        "spread_max": [0.015, 0.02],
        "early_pct": [0.2, 0.3],
        "late_pct": [0.3, 0.4],
        "late_seconds": [8, 10],
        "vol_cap_60s": [0.03, 0.04],
        "flip_rate_cap_60s": [0.22, 0.30],
        "momentum_gap_min": [0.012, 0.016],
        "accel_min": [0.001, 0.002]
    }
